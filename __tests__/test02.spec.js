...
describe('2. Feladat', () => {
    ...
    test('Vissza kellene adni az összes sütit a cookieHandler.getAll metódusnak.', async () => {
        await page.waitForSelector('#for-test');
    ...
    test('El kellene mentenie a cookieHandler.toSessionStorage metódusnak az összes sütit a sessionStorage -ba.', async () => {
        await page.waitForSelector('#for-test');
    ...
    test('A cookieHandler.flush metódusnak az összes sütit a törölnie kellene.', async () => {
        await page.evaluate(() => {
